...
M.inverted_keymap_mode_adapters =
    table_util.read_only(inverted_keymap_mode_adapters, new_index)
...
M.valid_integration_defaults =
    table_util.read_only(valid_integration_defaults, new_index)
...
M.valid_keymap_group_memebers =
    table_util.read_only(valid_keymap_group_memebers, new_index)
...
M.valid_keymap_group_opts =
    table_util.read_only(valid_keymap_group_opts, new_index)
