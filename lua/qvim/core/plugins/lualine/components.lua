...
return {
	...
	lsp = {
		function()
			...
			if #buf_clients == 0 then
				return highlights.ItemInactiveGreyLighterBg(
					qvim.icons.ui.LanguageServer
				)
			end
			...
			return highlights.ItemActiveGreyLighterBg(
				qvim.icons.ui.LanguageServer
			) .. " " .. highlights.TextOneGreyLighterBg(
		...
		padding = { left = 1, right = 1 },
		separator = {
			left = highlights.ComponentSeparatorGreyLighterFgGreyBg(
				qvim.icons.ui.BoldCircleDividerRight
			),
		},
	},
	diagnostics_source = {
		function()
			...
			if #diagnostics == 0 or not diagnostics then
				return highlights.ItemInactiveGreyLighterBg(
					qvim.icons.ui.DiagnosticsSource
				)
			else
				return highlights.ItemActiveGreyLighterBg(
					qvim.icons.ui.DiagnosticsSource
	...
	code_action_source = {
		function()
			...
			if #code_actions == 0 or not code_actions then
				return highlights.ItemInactiveGreyLighterBg(
					qvim.icons.ui.CodeActionSource
				)
			else
				return highlights.ItemActiveGreyLighterBg(
					qvim.icons.ui.CodeActionSource
	...
	copilot = {
		...
		padding = { left = 1, right = 1 },
		separator = {
			left = highlights.ComponentSeparatorGreyFgLighterGreyBg(
				qvim.icons.ui.BoldCircleDividerRight
			),
			right = {
				highlights.ComponentSeparatorGreyBg(qvim.icons.misc.Stars),
			},
		},
	},
	noice_recording = {
