...
---Get the full path to `$qvimVIM_RUNTIME_DIR`
---@return string|nil
function _G.get_runtime_dir()
  local qvim_runtime_dir = os.getenv "qvimVIM_RUNTIME_DIR"
...
---Get the full path to `$qvimVIM_CONFIG_DIR`
---@return string|nil
function _G.get_config_dir()
  local qvim_config_dir = os.getenv "qvimVIM_CONFIG_DIR"
...
---Get the full path to `$qvimVIM_CACHE_DIR`
---@return string|nil
function _G.get_cache_dir()
  local qvim_cache_dir = os.getenv "qvimVIM_CACHE_DIR"
...
function M:init(base_dir)
  ...
  ---@meta overridden to use qvimVIM_CACHE_DIR instead, since a lot of plugins call this function internally
  ...
  ---Get the full path to qvimVim's base directory
  ---@return string
  function _G.get_qvim_base_dir()
    return base_dir
  end

  if os.getenv "qvimVIM_RUNTIME_DIR" then
...
function M:update()
  require("qvim.core.log"):info "Trying to update qvimVim..."
