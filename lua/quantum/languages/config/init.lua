...
-- the "quantum.languages.config.setup" module, which should contain the languages.
-- The function also requires the "quantum.languages.config.lang_base" module,
...
function M:new(languages)
  ...
  local languages = languages or utils:require_module("quantum.languages.config.setup")
  
  local m_status_ok, lang_base = utils:require_module("quantum.languages.config.lang_base", true)
