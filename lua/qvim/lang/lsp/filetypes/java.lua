    ...
    keymaps:register {
        {
            ...
            bindings = {
                ...
                v = {
                    rhs = "<Cmd>lua require('jdtls').extract_variable()<CR>",
                    desc = "Extract Variable",
                },
                c = {
                    rhs = "<Cmd>lua require('jdtls').extract_constant()<CR>",
                ...
                T = {
                    rhs = "<Cmd>lua require'jdtls'.test_class()<CR>",
                    desc = "Test Class",
                },
    ...
    keymaps:register {
        {
            ...
            bindings = {
                v = {
                    rhs = "<Esc><Cmd>lua require('jdtls').extract_variable(true)<CR>",
                    desc = "Extract Variable",
                },
                c = {
                    rhs = "<Esc><Cmd>lua require('jdtls').extract_constant(true)<CR>",
                    desc = "Extract Constant",
                },
                m = {
                    rhs = "<Esc><Cmd>lua require('jdtls').extract_method(true)<CR>",
                    desc = "Extract Method",
                },
            },
            options = {
