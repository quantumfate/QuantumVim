...
local tree_climber = {
	...
	keymaps = {
		mappings = {
			["H"] = {
				callback = require("tree-climber").goto_parent,
				desc = "Climb to parent node.",
			},
			["L"] = {
				callback = require("tree-climber").goto_child,
				desc = "Climb to child node.",
			},
			["J"] = {
				callback = require("tree-climber").goto_next,
				desc = "Climb to next node.",
			},
			["K"] = {
				callback = require("tree-climber").goto_prev,
				desc = "Climb to previous node.",
			},
			["<c-k>"] = {
