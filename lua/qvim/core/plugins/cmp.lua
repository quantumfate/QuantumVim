        ...
        options = {
            ...
            formatting = {
                ...
                format = function(entry, vim_item)
                    local max_width =
                        qvim.integrations.cmp.options.formatting.max_width
                    if max_width ~= 0 and #vim_item.abbr > max_width then
                        vim_item.abbr = string.sub(
                            vim_item.abbr,
                            1,
                            max_width - 1
                    ...
                    if qvim.use_icons then
                        vim_item.kind =
                            qvim.builtin.cmp.formatting.kind_icons[vim_item.kind]
                    ...
                    vim_item.menu =
                        qvim.integrations.cmp.options.formatting.source_names[entry.source.name]
                ...
                ["<CR>"] = cmp_mapping(function(fallback)
                    if _cmp.visible() then
                        local confirm_opts = vim.deepcopy(
                            qvim.integrations.cmp.options.confirm_opts
                        ...
                        local is_copilot = entry
                            and entry.source.name == "copilot"
                        if is_copilot then
