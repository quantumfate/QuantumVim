...
binding.mt = {
    ...
    __newindex = function(t, opt, setting)
        if
            (type(opt) == "number" and type(setting) == "string" and #t <= 2)
            or default.valid_binding_opts[opt]
        then
    ...
    __tostring = function(t)
        ...
        return string.format(
            ...
            constants.neovim_options_constants.mode .. "=" .. type(t.mode) == "table" and mode_str
                or t.mode,
            constants.neovim_options_constants.noremap
                .. "="
                .. tostring(t.noremap),
            constants.neovim_options_constants.nowait
                .. "="
                .. tostring(t.nowait),
            constants.neovim_options_constants.silent
                .. "="
                .. tostring(t.silent),
            constants.neovim_options_constants.script
                .. "="
                .. tostring(t.script),
            constants.neovim_options_constants.expr .. "=" .. tostring(t.expr),
            constants.neovim_options_constants.unique
                .. "="
                .. tostring(t.unique),
            constants.neovim_options_constants.buffer
                .. "="
                .. tostring(t.buffer)
        )
    end,
