        ...
        keymaps = {
            {
                ...
                bindings = {
                    ...
                    c = {
                        rhs = "<cmd>Telescope colorscheme<cr>",
                        desc = "Colorscheme",
                    },
                    h = {
...
function M:config()
    ...
    qvim.integrations.telescope.options =
        vim.tbl_deep_extend("force", _telescope_options, _telescope_extensions)
end
...
function M:setup()
    ...
    if not status_ok then
        Log:warn(
            string.format("The plugin '%s' could not be loaded.", telescope)
        )
        return
    end
    ...
    local theme =
        require("telescope.themes")["get_" .. (_telescope.theme or "")]
    if theme then
